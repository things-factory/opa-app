...
class CompletedReleaseOrder extends connect(store)(localize(i18next)(PageView)) {
  ...
  get context() {
    return {
      title: i18next.t('title.completed_release_order'),
      actions: [
        {
...
window.customElements.define('completed-release-order', CompletedReleaseOrder)
