...
class CompletedReleaseDelivery extends connect(store)(localize(i18next)(PageView)) {
...
window.customElements.define('completed-release-delivery', CompletedReleaseDelivery)
